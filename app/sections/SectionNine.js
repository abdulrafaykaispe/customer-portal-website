...
export default function SectionNine({ content }) {
  const {
    homePage: { sectionNine },
  } = content;
      ...
      <div className="grid lg:grid-cols-2 sm:grid-cols-1 items-center justify-center gap-16">
        ...
        <div className="flex flex-col lg:items-start sm:items-center lg:order-2 sm:order-1">
          <SectionHeading
            ...
            heading={sectionNine.mainHeading}
            paragraph={sectionNine.mainParagraph}
          />

          <div className="space-y-9">
            {sectionNine.gridData.map((item, index) => (
              <div
                key={index}
                className="flex lg:flex-row sm:flex-col gap-4 lg:justify-start lg:items-start sm:items-center sm:justify-start"
              >
